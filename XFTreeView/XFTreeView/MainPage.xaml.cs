...
using XFTreeView.Service;

using Xamarin.Forms;

namespace XFTreeView
{
    ...
    public partial class MainPage : ContentPage
    {
                    ...
                    Children =
                        {
                            new ResourceImage
                            {
                                Resource = isItem? "XFTreeView.Resource.Item.png" :"XFTreeView.Resource.FolderOpen.png" ,
                                HeightRequest= 16,
                                WidthRequest = 16
                            },
                            label
        ...
        public class ExpandButtonContent : ContentView
        {
            ...
            protected override void OnBindingContextChanged()
            {
                ...
                if ((isLeafNode) && !node.ShowExpandButtonIfEmpty)
                {
                    ...
                    {
                        Resource = isLeafNode ? "XFTreeView.Resource.Blank.png" : "XFTreeView.Resource.FolderOpen.png",
                        HeightRequest = 16,
                        WidthRequest = 16
                    };
                }
                else
                {
                    Content = new ResourceImage
                    {
                        Resource = node.IsExpanded ? "XFTreeView.Resource.OpenGlyph.png" : "XFTreeView.Resource.CollpsedGlyph.png",
                        HeightRequest = 16,
                        WidthRequest = 16
                    };
                }
        ...
        {
            var selectedItem = TheTreeView.SelectedItem?.BindingContext as Department;
            if (selectedItem != null)
            {
                await DisplayAlert("Item Selected", $"Selected Content: {selectedItem.DepartmentName}", "OK");
            }
        }
    }
}
