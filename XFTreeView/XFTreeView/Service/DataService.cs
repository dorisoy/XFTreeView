...
using XFTreeView.Model;

namespace XFTreeView.Service
{
    public static class DataService
    {
                    ...
                    foreach (var group in companyGroup.Children)
                    {
                        ...
                        if (parentGroup != null)
                        {
                            if (parentGroup.Children.Count == 0)
                            {
                                ...
                                item.ItemId = dept.DepartmentId;
                                item.Key = dept.DepartmentName;
        ...
        private static List<Department> GetDepartments()
        {
            ...
            {
                new Department() { DepartmentId = 1, DepartmentName = "其他账户", ParentDepartmentId = -1 },
                new Department() { DepartmentId = 2, DepartmentName = "库存现金", ParentDepartmentId = -1 },
                new Department() { DepartmentId = 3, DepartmentName = "预收账款", ParentDepartmentId = -1 },
                new Department() { DepartmentId = 4, DepartmentName = "银行存款", ParentDepartmentId = -1 },

                new Department() { DepartmentId = 5, DepartmentName = "现金", ParentDepartmentId = 1 },
                new Department() { DepartmentId = 6, DepartmentName = "支付宝", ParentDepartmentId = 2 },
                new Department() { DepartmentId = 7, DepartmentName = "微信", ParentDepartmentId = 2 },
                new Department() { DepartmentId = 8, DepartmentName = "银行", ParentDepartmentId = 2 },
                new Department() { DepartmentId = 9, DepartmentName = "预收款", ParentDepartmentId = 3 },
                new Department() { DepartmentId = 10, DepartmentName = "银行", ParentDepartmentId = 4 }
            };
        }
